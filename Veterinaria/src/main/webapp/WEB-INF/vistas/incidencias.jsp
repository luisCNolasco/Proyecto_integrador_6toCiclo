...
<div class="container">
 <h3>Crud de Alumno</h3>
		 <div class="col-md-23" >  
				  <form id="id_form_elimina" action="eliminaCrudAlumno">
		 ...
		 $('#id_table').DataTable({
				...
				columns:[
					...
					{data: function(row, type, val, meta){
						var salida='<button type="button" style="width: 90px" class="btn btn-info btn-sm" onclick="editar(\''+row.idAlumno + '\',\'' + row.nombre +'\',\'' + row.dni  + '\',\'' + row.correo + '\',\'' + row.strFechaFormateada + '\')">Editar</button>';
						return salida;

			  	...
			  	<form  id="id_registra" action="guardarUsuario" method="POST">
					...
					<div class="row">	
						...
						<div class="col-md-3">
							<div class="form-group">
								<label>DNI</label>
								<input type="text" class="form-control" id="dni_usu" name="dni_usu" placeholder="Ingrese n˙mero de DNI" maxlength="8">
							</div>
						</div>		
					</div>
					<div class="row">	
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="password" class="form-control" id="pass_usu" name="pass_usu" placeholder="Ingrese la contraseÒa">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
...
function tablaUsuario(){
	...
	function eliminar(cod_usu){		
		swal({
			  ...
			  text: "Se eliminar· el usuario con cÛdigo : "+cod_usu,
			  icon: "warning",
			  buttons: true,
			  dangerMode: true,
			})
    ...
    fields: {
        ...
        "dni_usu":{
            ...
            validators:{
               ...
               regexp: {
					regexp: /^[0-9]{8}$/,
					message: 'El DNI tiene 8 dÌgitos'
	            }
            }
       },
       "pass_usu":{
